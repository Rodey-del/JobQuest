...
export const addUserApi=(data)=> api.post("api/user/create",data);

export const loginApi=(data)=> api.post("api/user/login",data);

export const getAllUsersForAdminApi=()=> api.get("api/user/getUsersAdmin");

export const getUserbyId=(id)=> api.get(`api/user/getSingleUser/${id}`);
