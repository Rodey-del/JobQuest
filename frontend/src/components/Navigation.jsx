      ...
      <div >
        ...
        <div className={`navbar ${isNavOpen ? "nav-open" : ""}`}>
          <div className="left-section">
            ...
            <nav className={isNavOpen ? "nav-open" : ""}>
              ...
              <div className="menubar flex justify-center items-center">
                ...
                <Link className={isActiveLink("/jobs") ? "active" : ""} to="/jobs">
                  <i className="fas fa-briefcase"></i>
                  <span>Jobs</span>
                </Link>
                {/* <a href="#"><i className="fas fa-info-circle"></i> About Us</a> */}
                <Link className={isActiveLink("/contact") ? "active" : ""} to="/contact">
                  <i className="fas fa-envelope"></i>
                  <span>Contact</span>
                </Link>
                <Link className={isActiveLink("/cvmaker") ? "active" : ""} to="/cvmaker">
                ...
                <div className="search-section relative">
                  <div className="search-div relative">
                    ...
                    <input
                      ...
                      className="search-input pl-8 pr-4 rounded-full focus:outline-none focus:shadow-outline border border-gray-300 text-black"
                    />
                  </div>
                  {showSearchResults && (
                    <div
                      ref={dropdownRef}
                      className="search-results-dropdown absolute z-20 mt-2 w-full max-h-90 overflow-y-auto bg-white border rounded-lg shadow-md"
                    >
          ...
          <div className="right-section">
            {user ? (
              <>
                <Link to={"/user/profile"} className="signup-button ">
          ...
          {/* <div className="right-section">
            ...
            <div className="phone-number">9815038876</div>
          </div> */}
        </div>
