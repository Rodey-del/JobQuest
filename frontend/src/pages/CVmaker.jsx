...
const CVmaker = () => {
  ...
  // const [backgroundColor, setBackgroundColor] = useState("linear-gradient(to right, #22c55e, #3b82f6)");
  // Set a default color
  ...
  const DownloadCv = () => {
    ...
    if (contentElement) {
      ...
      html2canvas(contentElement).then((canvas) => {
        ...
        // doc.save("my_cv.pdf");
        const filename = data.name ? `${data.name.replace(/ /g, '_')}_cv.pdf` : 'my_cv.pdf';
        doc.save(filename);
      });
    }
  };
  ...
  return (
    <div className="p-4 flex items-start">
      <div className="w-2/6 p-4" style={{ border: '1px solid black', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>        <h1 className="text-2xl font-bold mb-4">Personal Information</h1>
      ...
      <div className="w-3/4 h-[100vh] bg-gray-100 p-8 sticky top-0 z-10">
    <div className="bg-white shadow-xl rounded-lg p-8 flex flex-col space-y-8 max-h-full overflow-y-auto" id="cvViewer">

          {/* Header Section */}
          <div className="flex flex-col items-center p-8 rounded-lg text-white" style={{ backgroundColor }}>
            <div className="mb-4">
              {data.image ? (
                <img
                  src={data.image}
                ...
                <div className="rounded-full h-32 w-32 flex items-center justify-center bg-white border-4 border-gray-300 mx-auto shadow-md">
                  <i className="fas fa-user text-gray-500 text-3xl"></i>
                </div>
              )}
            </div>
            <h1 className="text-4xl font-bold">{data.name}</h1>
            <p className="text-lg">{data.email} | {data.phone}</p>
          </div>
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full lg:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <p className="mb-2"><strong>Father's Name:</strong> {data.fatherName}</p>
                <p className="mb-2"><strong>Mother's Name:</strong> {data.motherName}</p>
                <p className="mb-2"><strong>Date of Birth:</strong> {data.dateOfBirth}</p>
            ...
            <div className="w-full lg:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow p-6">
                <h2 className="text-2xl font-bold text-gray-700 mb-4">Social Media</h2>
                {data.githubUrl && (
              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                {data.achievement1 && (
                  <p className="mb-2 text-gray-700">
                    ...
                    <strong>1:</strong> {data.achievement1}
                  </p>
                )}
                {data.achievement2 && (
                  <p className="mb-2 text-gray-700">
                    <i className="fa-solid fa-star mr-2"></i>
                    <strong>2:</strong> {data.achievement2}
                  </p>
                )}
                {data.achievement3 && (
                  <p className="mb-2 text-gray-700">
                    <i className="fa-solid fa-star mr-2"></i>
                    <strong>3:</strong> {data.achievement3}
                  </p>
                )}
                {data.achievement4 && (
                  <p className="mb-2 text-gray-700">
                    <i className="fa-solid fa-star mr-2"></i>
                    <strong>4:</strong> {data.achievement4}
                  </p>
                )}
              </div>
            </div>
