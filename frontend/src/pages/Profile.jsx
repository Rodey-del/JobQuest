  ...
  return (
    <div className="container mx-auto mt-8 p-4">
      <div className="max-w-lg mx-auto bg-white rounded-md overflow-hidden shadow-md">
        <div className="bg-gradient-to-r from-blue-600 to-blue-400 flex justify-between items-center p-4">
        ...
        <div className="p-4">
          <div className="flex items-center justify-center mb-4">
            <label htmlFor="profileImage" className="cursor-pointer">
              <img
                ...
                alt="User Profile"
                className="w-20 h-20 rounded-full mx-auto mb-4 border-2 border-blue-500 cursor-pointer"
                onClick={() =>
                  editMode &&
              ...
              {user.cvFile ? (
                <>
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-600 to-blue-400 text-white py-2 px-4 mb-4 rounded w-1/3"
                  >
          ...
          <div className="flex mb-4">
            <button
              className={`flex-1 py-2 px-4 ${activeTab === "userDetail"
            ...
            <button
              className={`flex-1 py-2 px-4 ${activeTab === "changePassword"
            ...
            <button
              className={`flex-1 py-2 px-4 ${activeTab === "savedJobs"
                ? "bg-gradient-to-r from-blue-600 to-blue-600 text-white"
                : "bg-gray-300"
                }`}
            ...
            <button
              className={`flex-1 py-2 px-4 ${activeTab === "appliedJobs"
                ? "bg-gradient-to-r from-blue-600 to-blue-600 text-white"
                : "bg-gray-300"
                }`}
            ...
            <div>
              ...
              {editMode ? (
                <>
                  ...
                  <label className="block mb-4">
                    <span className="text-sm textgray-600">Address:</span>
                    <input
                      type="text"
                      className="form-input mt-1 block w-full"
              ...
              {/* Edit Profile Button */}
                <button
                  className={` bg-gradient-to-r from-green-600 to-green-600 text-white py-2 px-4 mb-4 rounded shadow-lg transform transition duration-300 hover:scale-105 ${editMode ? "hidden" : "block w-full mt-4"
                    }`}
                ...
                {editMode && (
                  <button
                    className="bg-gradient-to-r from-green-600 to-green-400 text-white py-2 px-4 mb-4 rounded w-full"
            ...
            <div>
              ...
              <>
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-600 to-green-600 py-1 px-4 rounded text-white items-center  mt-4 w-full"
                >
                  Change Password
                </button>
              </>
              ...
              {loading ? (
                ...
                <div className="w-full flex-1 p-4 flex flex-wrap">
                  {jobSavedItems.map((job, index) => (
                    <div
                      key={index}
                      className="bg-blue-100 sm:w-full flex p-4 m-2 justify-between items-center border rounded"
                    >
                      <div
                        className="flex "
                      ...
                      >
                        ...
                        <div className="items-center flex-col w-4/5 pl-2">
                      ...
                      <i
                        className={`fa-solid fa-heart ml-5 text-red-500 ${favoritedJobs.includes(job._id) ? "fas" : ""
                          }`}
                        onClick={() => {
                ...
                <div className="w-full flex-1 p-4 flex flex-wrap">
                  {appliedJobs.slice(0, 6).map((job, index) => (
                    ...
                    >
                      ...
                      {job.isVerified ? (
                        <h3
                          className=" bg-gradient-to-r from-green-600 to-green-600 py-1 px-2 rounded text-white"
                          title={job.interview}
