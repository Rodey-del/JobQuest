  ...
  return (
    <div className="">
      {loading ? (
        ...
        <div>
          <h3 className="text-2xl font-bold mb-2 ml-6 mt-4 text-blue-500 text-center">
            All Jobs
          </h3>
          <div className="w-full flex-1 p-4 flex flex-wrap justify-center">
            {jobItems.map((job, index) => (
              <div
                key={index}
                className="bg-blue-100 sm:w-full md:w-1/3 flex p-4 m-2 justify-between items-center border rounded"
              >
                <div
