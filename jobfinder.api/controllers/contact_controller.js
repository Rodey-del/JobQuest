...
const replyMessage = async (req, res) => {
    ...
    try {
      ...
      if (email) {
        const emailSubject = 'Reply to the message you send through our website.';
        const emailText = `Reply:${message}

        
This is an auto generated email by admin so please do not reply to this mail.If you have any query then please fell free to contact in the number that we have provided in the site.
Thank you!!
      `;
